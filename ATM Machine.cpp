...
int main () 
{
	...
	cout<<"1 for the current balance of your account \n" //\n are end of lines
	<<"2 for deposit \n"
	...
	while(input!= 0) {
		...
		case 2: cout<<"Please enter an amount to deposit"<<endl;
		cin>>deposit;
		...
		case 4: cout<<"The current balance after all transactions:"<<balance<<endl;
		break;
